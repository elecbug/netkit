...
func testBarabasiAlbertGraph(t *testing.T) {
	...
	for i := 0; i < trial; i++ {
		...
		go func(i int) {
			...
			g, err := standard.BarabasiAlbertGraph(i, false, nil, n, m)
			if err != nil {
...
func testErdosRenyiGraph(t *testing.T) {
	...
	for i := 0; i < trial; i++ {
		...
		go func(i int) {
			...
			g, err := standard.ErdosRenyiGraph(i, false, nil, n, p)
			if err != nil {
...
func testRandomGeometricGraph(t *testing.T) {
	...
	for i := 0; i < trial; i++ {
		...
		go func(i int) {
			...
			g, err := standard.RandomGeometricGraph(i, false, nil, n, r)
			if err != nil {
...
func testRandomRegularGraph(t *testing.T) {
	...
	for i := 0; i < trial; i++ {
		...
		go func(i int) {
			...
			g, err := standard.RandomRegularGraph(i, false, nil, n, int(k))
			if err != nil {
...
func testWattsStrogatzGraph(t *testing.T) {
	...
	for i := 0; i < trial; i++ {
		...
		go func(i int) {
			...
			g, err := standard.WattsStrogatzGraph(i, false, nil, n, int(k), beta)
			if err != nil {
...
func testGridGraph(t *testing.T) {
	...
	g, err := standard.GridGraph(0, false, nil, rows, cols, torus)
	if err != nil {
...
func testTriangleHexGraph(t *testing.T) {
	...
	g, err := standard.TriangleHexGraph(0, false, nil, edge)
	if err != nil {
...
func testGenerateFromConfig(t *testing.T) {
	...
	for i, config := range configs {
		g, err := standard.StandardGraph(i, false, nil, config)
		if err != nil {
	...
	for i, config := range invalidConfigs {
		if _, err := standard.StandardGraph(i, false, nil, config); err == nil {
